...
const C = {
  ...
  danger: "#C0392B",
  dangerLight: "#FFF5F5",
  chart: ["#111110", "#4A4A44", "#9A9A94", "#2D7A3A", "#D97706", "#C0392B", "#0F766E"]
};
const FONT_SANS = "'Inter', system-ui, sans-serif";
const FONT_MONO = "'JetBrains Mono', monospace";

;// ./src/ui.jsx
/* unused harmony import specifier */ var ui_C;


const ease = {
  out: (t) => esm.Easing.bezier(0.16, 1, 0.3, 1)(t),
  inOut: (t) => esm.Easing.bezier(0.45, 0, 0.55, 1)(t),
  pop: (t) => esm.Easing.bezier(0.34, 1.56, 0.64, 1)(t)
};
function lerp(frame, [f0, f1], [v0, v1], easing = null) {
  return (0,esm.interpolate)(frame, [f0, f1], [v0, v1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing
  });
}
function FlaskIcon({ size = 16, color = C.textPrimary }) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M9 3h6M9 3v7l-5 9a1 1 0 00.9 1.5h12.2A1 1 0 0018 19l-5-9V3" })
  );
}
function CheckIcon({ size = 14, color = ui_C.success }) {
  return /* @__PURE__ */ React.createElement(
    "svg",
    {
      width: size,
    ...
    /* @__PURE__ */ React.createElement("polyline", { points: "9 12 11.5 14.5 15 10" })
  );
}
function MicIcon({ size = 14, color = C.textPrimary }) {
  return /* @__PURE__ */ React.createElement(
    "svg",
    {
      width: size,
    ...
    /* @__PURE__ */ React.createElement("rect", { x: "9", y: "2", width: "6", height: "11", rx: "3" }),
...
function NavBar({ version = "v1.0" }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    padding: "0 32px",
    flexShrink: 0
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement(FlaskIcon, { size: 15 }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 13,
    letterSpacing: "-0.02em",
    color: C.textPrimary
  } }, "LabProcure")), /* @__PURE__ */ React.createElement("span", { style: {
...
function ProgressBar({ pct, style }) {
  return /* @__PURE__ */ React.createElement("div", { style: { height: 4, borderRadius: 2, background: C.borderSoft, overflow: "hidden", ...style } }, /* @__PURE__ */ React.createElement("div", { style: { height: "100%", width: `${pct}%`, background: C.black, borderRadius: 2 } }));
}
function TabPill({ label, active }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    border: active ? `1px solid ${C.borderSoft}` : "1px solid transparent",
    letterSpacing: "-0.01em",
    whiteSpace: "nowrap"
  } }, label);
}
function SpinningFlask({ size = 40, frame }) {
  const angle = frame * 6 % 360;
  return /* @__PURE__ */ React.createElement("div", { style: { transform: `rotate(${angle}deg)`, display: "inline-flex" } }, /* @__PURE__ */ React.createElement(FlaskIcon, { size }));
}
...
function Scene0_Hook() {
  const frame = (0,esm.useCurrentFrame)();
  const flaskOp = lerp(frame, [0, 20], [0, 1], ease.out);
  const flaskSc = lerp(frame, [0, 20], [0.6, 1], ease.out);
  const line1Op = lerp(frame, [18, 32], [0, 1], ease.out);
  const line1Y = lerp(frame, [18, 32], [10, 0], ease.out);
  const line2Op = lerp(frame, [28, 42], [0, 1], ease.out);
  const line2Y = lerp(frame, [28, 42], [10, 0], ease.out);
  const tagOp = lerp(frame, [40, 55], [0, 1], ease.out);
  const tagY = lerp(frame, [40, 55], [8, 0], ease.out);
  const badgeOp = lerp(frame, [52, 65], [0, 1], ease.out);
  const badgeSc = lerp(frame, [52, 65], [0.9, 1], ease.pop);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
    ...
    opacity: flaskOp,
    transform: `scale(${flaskSc})`,
    display: "flex",
    alignItems: "center",
    gap: 12,
    marginBottom: 32
  } }, /* @__PURE__ */ React.createElement(FlaskIcon, { size: 32, color: C.textPrimary }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 18,
    letterSpacing: "-0.02em",
    color: C.textMuted
  } }, "LabProcure")), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { opacity: line1Op, transform: `translateY(${line1Y}px)` } }, /* @__PURE__ */ React.createElement("h1", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 72,
    lineHeight: 1.08,
    ...
    color: C.textPrimary,
    margin: 0
  } }, "From hypothesis to lab order")), /* @__PURE__ */ React.createElement("div", { style: { opacity: line2Op, transform: `translateY(${line2Y}px)` } }, /* @__PURE__ */ React.createElement("h1", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 72,
    lineHeight: 1.08,
    ...
    color: C.textMuted,
    margin: 0
  } }, "in 30 seconds."))), /* @__PURE__ */ React.createElement("div", { style: { opacity: tagOp, transform: `translateY(${tagY}px)`, marginTop: 28 } }, /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontSize: 19,
    lineHeight: 1.6,
    ...
    textAlign: "center",
    margin: 0
  } }, "AI-powered protocol design, literature review & agentic procurement \u2014 all in one platform.")), /* @__PURE__ */ React.createElement("div", { style: { opacity: badgeOp, transform: `scale(${badgeSc})`, marginTop: 36 } }, /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 12,
    fontWeight: 500,
    padding: "5px 14px",
...
;// ./src/Scene1_Input.jsx



const HYPOTHESIS = "Replacing sucrose with trehalose as a cryoprotectant will increase post-thaw viability of HeLa cells by at least 15 percentage points.";
const EXAMPLES = [
...
function Scene1_Input() {
  const frame = (0,esm.useCurrentFrame)();
  const sceneOp = lerp(frame, [0, 12], [0, 1], ease.out);
  const typingProgress = lerp(frame, [8, 80], [0, 1], ease.inOut);
  const charCount = Math.floor(typingProgress * HYPOTHESIS.length);
  const typedText = HYPOTHESIS.slice(0, charCount);
  const cursorVisible = frame % 18 < 10;
  const wordCount = typedText.trim().length > 0 ? typedText.trim().split(/\s+/).length : 0;
  const btnSc = frame > 84 ? lerp(frame - 84, [0, 6], [1, 0.97], ease.out) : 1;
  const calloutOp = lerp(frame, [30, 42], [0, 1], ease.out);
  const calloutY = lerp(frame, [30, 42], [8, 0], ease.out);
  const ex0Op = lerp(frame, [4, 16], [0, 1], ease.out);
  const ex0X = lerp(frame, [4, 16], [-12, 0], ease.out);
  const ex1Op = lerp(frame, [10, 22], [0, 1], ease.out);
  const ex1X = lerp(frame, [10, 22], [-12, 0], ease.out);
  const ex2Op = lerp(frame, [16, 28], [0, 1], ease.out);
  const ex2X = lerp(frame, [16, 28], [-12, 0], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { background: C.bgBase, opacity: sceneOp, flexDirection: "column" } }, /* @__PURE__ */ React.createElement(NavBar, null), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    justifyContent: "center",
    padding: "48px 24px"
  } }, /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 560, display: "flex", flexDirection: "column", gap: 28 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 44,
    lineHeight: 1.1,
    ...
    color: C.textPrimary,
    margin: 0
  } }, "Agentic Lab Procurement", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: C.textMuted, fontWeight: 400 } }, "for Scientists")), /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontSize: 14,
    lineHeight: 1.65,
    color: C.textMuted,
    marginTop: 10,
    maxWidth: 460
  } }, "LabProcure automates your workflow from protocol design to lab procurement.")), /* @__PURE__ */ React.createElement("div", { style: { background: C.bgSurface, border: `1px solid ${C.borderSoft}`, borderRadius: 8 } }, /* @__PURE__ */ React.createElement("div", { style: {
  ...
  } }, typedText || /* @__PURE__ */ React.createElement("span", { style: { color: C.textMuted } }, "Describe your hypothesis\u2026"), typedText && cursorVisible && /* @__PURE__ */ React.createElement("span", { style: {
  ...
  } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 12, color: C.textMuted } }, wordCount > 0 ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("strong", { style: { color: C.textSecondary } }, wordCount), " words") : "Intervention \xB7 outcome \xB7 threshold", /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 10, opacity: 0.5, fontFamily: FONT_MONO, fontSize: 11 } }, "\u2318\u21B5")), /* @__PURE__ */ React.createElement("button", { style: {
    background: C.black,
    color: C.white,
    fontFamily: FONT_SANS,
    fontWeight: 500,
    ...
    opacity: wordCount > 0 ? 1 : 0.35
  } }, "Analyse \u2192"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 600,
    fontSize: 10,
    textTransform: "uppercase",
    ...
    { text: EXAMPLES[0], op: ex0Op, x: ex0X },
    { text: EXAMPLES[1], op: ex1Op, x: ex1X },
    { text: EXAMPLES[2], op: ex2Op, x: ex2X }
  ].map(({ text, op, x }, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    opacity: op,
    ...
    color: C.textSecondary,
    letterSpacing: "-0.01em"
  } }, text))))), calloutOp > 0.05 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: 280,
    right: 120,
    opacity: calloutOp,
    ...
    whiteSpace: "nowrap"
  } }, "Type your hypothesis"), /* @__PURE__ */ React.createElement("div", { style: {
    width: 0,
    height: 0,
    ...
    display: "flex",
    justifyContent: "center"
  } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textMuted } }, "\xA9 2026 LabProcure")));
}

;// ./src/Scene2_LitQC.jsx



const PAPERS = [
  {
    title: "Trehalose as cryoprotectant for mammalian cells",
    authors: "Acker et al., 2010",
    journal: "Cryobiology",
    year: "2010",
    relevance: 96
  },
  {
    title: "HeLa cell viability post-thaw: sucrose vs. DMSO",
    authors: "Chen & Park, 2018",
    journal: "Cell Preservation Tech.",
    year: "2018",
    relevance: 89
  },
  {
    title: "Disaccharide cryoprotection mechanisms in human cell lines",
    authors: "Bhowmick et al., 2015",
    journal: "Cryobiology",
    year: "2015",
    relevance: 82
  }
...
const NOVELTY = {
  ...
  color: C.success,
  bg: C.successLight,
  border: "rgba(45,122,58,0.2)",
  dot: C.success,
  desc: "No existing protocols match this hypothesis. This appears to be unexplored territory \u2014 proceed with confidence."
};
const CHAT_MSGS = [
  { role: "user", text: "What are the key findings across these papers?" },
  { role: "agent", text: "The papers consistently show trehalose outperforms sucrose in post-thaw viability across human cell lines, with reported gains of 12\u201322%. HeLa cells specifically show ~18% improvement at 0.2 M concentrations." },
  { role: "user", text: "How novel is this hypothesis?" },
  { role: "agent", text: "No published protocol matches your exact threshold of \u226515 pp improvement in HeLa cells. The hypothesis is scientifically grounded and novel." }
];
function PaperCard({ paper, opacity, x }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    opacity,
    transform: `translateX(${x}px)`,
    background: C.bgSurface,
    ...
    margin: 0,
    letterSpacing: "-0.01em"
  } }, paper.title), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textMuted } }, paper.authors), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 10,
    color: C.textMuted,
    background: C.bgBase,
    ...
    padding: "1px 5px",
    borderRadius: 3
  } }, paper.journal, " \xB7 ", paper.year), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 10,
    fontWeight: 600,
    color: C.success,
...
function ChatBubble({ msg, opacity, y }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    padding: "8px 12px",
    borderRadius: 6,
    background: isUser ? C.white : "transparent",
    border: isUser ? `1px solid ${C.borderSoft}` : "none",
    fontFamily: FONT_SANS,
    fontSize: 12,
    lineHeight: 1.65,
...
function Scene2_LiteratureQC() {
  const frame = (0,esm.useCurrentFrame)();
  const sceneOp = lerp(frame, [0, 12], [0, 1], ease.out);
  const p0Op = lerp(frame, [6, 20], [0, 1], ease.out);
  const p0X = lerp(frame, [6, 20], [-16, 0], ease.out);
  const p1Op = lerp(frame, [14, 28], [0, 1], ease.out);
  const p1X = lerp(frame, [14, 28], [-16, 0], ease.out);
  const p2Op = lerp(frame, [22, 36], [0, 1], ease.out);
  const p2X = lerp(frame, [22, 36], [-16, 0], ease.out);
  const badgeOp = lerp(frame, [30, 44], [0, 1], ease.out);
  const badgeSc = lerp(frame, [30, 44], [0.9, 1], ease.pop);
  const m0Op = lerp(frame, [38, 50], [0, 1], ease.out);
  const m0Y = lerp(frame, [38, 50], [6, 0], ease.out);
  const m1Op = lerp(frame, [50, 62], [0, 1], ease.out);
  const m1Y = lerp(frame, [50, 62], [6, 0], ease.out);
  const m2Op = lerp(frame, [64, 76], [0, 1], ease.out);
  const m2Y = lerp(frame, [64, 76], [6, 0], ease.out);
  const m3Op = lerp(frame, [76, 90], [0, 1], ease.out);
  const m3Y = lerp(frame, [76, 90], [6, 0], ease.out);
  const calloutOp = lerp(frame, [34, 46], [0, 1], ease.out);
  const btnGlow = lerp(frame, [120, 140], [0, 1], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { background: C.bgBase, opacity: sceneOp, flexDirection: "column" } }, /* @__PURE__ */ React.createElement(NavBar, null), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "grid",
    ...
    alignItems: "center",
    justifyContent: "space-between"
  } }, /* @__PURE__ */ React.createElement(SectionLabel, null, "Literature"), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 10,
    fontWeight: 600,
    padding: "1px 6px",
    ...
    border: `1px solid ${C.borderSoft}`,
    color: C.textMuted
  } }, "3")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "6px 8px", display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement(PaperCard, { paper: PAPERS[0], opacity: p0Op, x: p0X }), /* @__PURE__ */ React.createElement(PaperCard, { paper: PAPERS[1], opacity: p1Op, x: p1X }), /* @__PURE__ */ React.createElement(PaperCard, { paper: PAPERS[2], opacity: p2Op, x: p2X }))), /* @__PURE__ */ React.createElement("div", { style: {
    background: C.bgSurface,
    borderRight: `1px solid ${C.borderSoft}`,
    display: "flex",
    flexDirection: "column",
    ...
    gap: 16,
    overflowY: "auto"
  } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SectionLabel, { style: { marginBottom: 8, display: "block" } }, "Your Hypothesis"), /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontSize: 13,
    lineHeight: 1.6,
    color: C.textPrimary,
    ...
    borderRadius: 6,
    margin: 0
  } }, "Replacing sucrose with trehalose as a cryoprotectant will increase post-thaw viability of HeLa cells by at least 15 percentage points.")), /* @__PURE__ */ React.createElement("div", { style: {
    opacity: badgeOp,
    transform: `scale(${badgeSc})`,
    transformOrigin: "top left"
  } }, /* @__PURE__ */ React.createElement("div", { style: {
    background: NOVELTY.bg,
    border: `1px solid ${NOVELTY.border}`,
    borderRadius: 8,
    padding: "12px 14px",
    display: "flex",
    flexDirection: "column",
    gap: 6
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 7, height: 7, borderRadius: "50%", background: NOVELTY.dot, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 13,
    color: NOVELTY.color,
    letterSpacing: "-0.01em"
  } }, NOVELTY.label)), /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontSize: 12,
    lineHeight: 1.55,
    color: C.textSecondary,
    margin: 0,
    letterSpacing: "-0.01em"
  } }, NOVELTY.desc))), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    gap: 20,
    padding: "8px 0",
    borderTop: `1px solid ${C.borderSoft}`,
    ...
    { label: "Papers Scanned", value: "3" },
    { label: "Relevance Score", value: "96%" },
    { label: "Novelty", value: "High" }
  ].map(({ label, value }) => /* @__PURE__ */ React.createElement("div", { key: label, style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React.createElement(SectionLabel, null, label), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 14,
    fontWeight: 600,
    color: C.textPrimary,
    letterSpacing: "-0.01em"
  } }, value)))), /* @__PURE__ */ React.createElement("button", { style: {
    background: C.black,
    color: C.white,
    fontFamily: FONT_SANS,
    fontWeight: 600,
    ...
    boxShadow: btnGlow > 0.1 ? `0 0 0 ${Math.round(btnGlow * 4)}px rgba(0,0,0,0.12)` : "none"
  } }, "Generate Experiment Plan \u2192")), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    flexDirection: "column",
    background: C.bgSurface,
    overflow: "hidden"
    ...
    alignItems: "center",
    gap: 8
  } }, /* @__PURE__ */ React.createElement("div", { style: { width: 6, height: 6, borderRadius: "50%", background: C.success } }), /* @__PURE__ */ React.createElement(SectionLabel, null, "Literature Chat")), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    overflowY: "auto",
    padding: "12px 14px",
    display: "flex",
    ...
    { msg: CHAT_MSGS[0], op: m0Op, y: m0Y },
    { msg: CHAT_MSGS[1], op: m1Op, y: m1Y },
    { msg: CHAT_MSGS[2], op: m2Op, y: m2Y },
    { msg: CHAT_MSGS[3], op: m3Op, y: m3Y }
  ].map(({ msg, op, y }, i) => /* @__PURE__ */ React.createElement(ChatBubble, { key: i, msg, opacity: op, y }))), /* @__PURE__ */ React.createElement("div", { style: {
    padding: "8px 12px",
    borderTop: `1px solid ${C.borderSoft}`,
    display: "flex",
    alignItems: "center",
    ...
    fontSize: 12,
    color: C.textMuted
  } }, "Ask about the literature\u2026"), /* @__PURE__ */ React.createElement("div", { style: {
    width: 28,
    height: 28,
    borderRadius: 6,
    background: C.black,
  ...
  ))))), calloutOp > 0.05 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: 340,
    left: 710,
    opacity: calloutOp
    ...
    whiteSpace: "nowrap"
  } }, "\u2713 Novel hypothesis detected")));
}

;// ./src/Scene3_Loading.jsx



function Scene3_Loading() {
  const frame = (0,esm.useCurrentFrame)();
  const overlayOp = lerp(frame, [0, 10], [0, 1], ease.out);
  const pct = lerp(frame, [0, 55], [0, 67], ease.inOut);
  const getStage = (f) => {
    if (f < 20) return "Scanning literature references\u2026";
    if (f < 38) return "Building protocol steps\u2026";
    return `Generating Experiment Plan`;
  };
  const stage = getStage(frame);
  const pctInt = Math.round(pct);
  const fadeOut = lerp(frame, [50, 60], [1, 0], ease.inOut);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
    background: "rgba(242,237,227,0.96)",
    opacity: overlayOp * fadeOut,
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    justifyContent: "center",
    gap: 32
  } }, /* @__PURE__ */ React.createElement(SpinningFlask, { size: 42, frame }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", maxWidth: 380, display: "flex", flexDirection: "column", gap: 12 } }, /* @__PURE__ */ React.createElement("h2", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 22,
    letterSpacing: "-0.03em",
    color: C.textPrimary,
    margin: 0
  } }, stage), /* @__PURE__ */ React.createElement(ProgressBar, { pct, style: { width: 320, margin: "0 auto" } }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 13,
    color: C.textMuted,
    letterSpacing: "-0.01em"
...
;// ./src/Scene4_Protocol.jsx



const STEPS = [
  "Prepare cell culture medium",
  "Harvest HeLa cells (80% confluency)",
  "Prepare cryoprotectant solutions",
  "Controlled-rate freezing protocol",
  "Thaw cells & assess viability",
  "Statistical analysis (n=6)"
];
const BUDGET_ITEMS = [
  { item: "D-(+)-Trehalose dihydrate 25g", cost: 38.5, supplier: "Sigma-Aldrich", sku: "T9531" },
  { item: "Sucrose (positive ctrl) 500g", cost: 22, supplier: "Sigma-Aldrich", sku: "S0389" },
  { item: "DMEM High Glucose 500mL \xD74", cost: 56, supplier: "ThermoFisher", sku: "11965092" },
  { item: "CryoTube vials 1mL \xD7500", cost: 44, supplier: "Nunc", sku: "375418" },
  { item: "HeLa cell line passage 10", cost: 120, supplier: "ATCC", sku: "CCL-2" },
  { item: "Trypan blue (viability dye)", cost: 18.5, supplier: "Sigma-Aldrich", sku: "T8154" },
  { item: "Overhead & consumables (22%)", cost: 79.42, supplier: "\u2014", sku: "\u2014" }
];
const TOTAL = BUDGET_ITEMS.reduce((s, i) => s + i.cost, 0);
const PIE_SLICES = [
  { label: "Reagents", pct: 0.35, color: C.chart[0] },
  { label: "Cell lines", pct: 0.22, color: C.chart[3] },
  { label: "Consumables", pct: 0.2, color: C.chart[1] },
  { label: "Culture media", pct: 0.1, color: C.chart[4] },
  { label: "Overhead", pct: 0.13, color: C.chart[2] }
];
function PieChart({ progress = 1 }) {
  const cx = 80, cy = 80, r = 60, innerR = 38;
  let startAngle = -Math.PI / 2;
  const paths = [];
  PIE_SLICES.forEach((slice, i) => {
    const angle = slice.pct * 2 * Math.PI * Math.min(progress * PIE_SLICES.length - i, 1);
    if (angle <= 0) return;
    const clampedAngle = Math.min(angle, slice.pct * 2 * Math.PI);
    ...
    const large = clampedAngle > Math.PI ? 1 : 0;
    paths.push(
      /* @__PURE__ */ React.createElement(
        "path",
        {
  ...
  return /* @__PURE__ */ React.createElement("svg", { width: 160, height: 160, viewBox: "0 0 160 160" }, paths, /* @__PURE__ */ React.createElement(
    "text",
    {
      x: cx,
      y: cy - 6,
    ...
    "$",
    Math.round(TOTAL)
  ), /* @__PURE__ */ React.createElement("text", { x: cx, y: cy + 10, textAnchor: "middle", fontSize: "9", fontFamily: FONT_SANS, fill: C.textMuted }, "TOTAL"));
}
function Scene4_Protocol() {
  const frame = (0,esm.useCurrentFrame)();
  const sceneOp = lerp(frame, [0, 14], [0, 1], ease.out);
  const stepOpArr = STEPS.map((_, i) => lerp(frame, [6 + i * 8, 20 + i * 8], [0, 1], ease.out));
  const stepXArr = STEPS.map((_, i) => lerp(frame, [6 + i * 8, 20 + i * 8], [-10, 0], ease.out));
  const showBudget = frame >= 50;
  const rowOpArr = BUDGET_ITEMS.map(
    (_, i) => lerp(frame, [52 + i * 5, 66 + i * 5], [0, 1], ease.out)
  );
  const pieProgress = lerp(frame, [54, 85], [0, 1], ease.inOut);
  const calloutOp = lerp(frame, [showBudget ? 55 : 200, showBudget ? 68 : 200], [0, 1], ease.out);
  const chat1Op = lerp(frame, [10, 22], [0, 1], ease.out);
  const chat2Op = lerp(frame, [28, 40], [0, 1], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { background: C.bgBase, opacity: sceneOp, flexDirection: "column" } }, /* @__PURE__ */ React.createElement(NavBar, null), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "grid",
    ...
    alignItems: "center",
    justifyContent: "space-between"
  } }, /* @__PURE__ */ React.createElement(SectionLabel, null, "Protocol"), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 10,
    fontWeight: 600,
    padding: "1px 6px",
    ...
    border: `1px solid ${C.borderSoft}`,
    color: C.textMuted
  } }, "6")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "4px 6px", display: "flex", flexDirection: "column", gap: 1 } }, STEPS.map((step, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    opacity: stepOpArr[i],
    transform: `translateX(${stepXArr[i]}px)`,
    display: "flex",
    ...
    marginTop: 5,
    flexShrink: 0,
    background: i < 2 ? C.success : C.textMuted
  } }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 12,
    lineHeight: 1.45,
    color: i === 1 ? C.textPrimary : C.textSecondary,
    fontWeight: i === 1 ? 600 : 400,
    letterSpacing: "-0.01em"
  } }, step))))), /* @__PURE__ */ React.createElement("div", { style: {
    background: C.bgSurface,
    borderRight: `1px solid ${C.borderSoft}`,
    display: "flex",
    flexDirection: "column",
    ...
    background: C.bgBase,
    flexShrink: 0
  } }, ["Protocol", "Budget", "Materials", "Timeline"].map((t) => /* @__PURE__ */ React.createElement(TabPill, { key: t, label: t, active: showBudget ? t === "Budget" : t === "Protocol" }))), !showBudget ? (
    /* Protocol view */
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "16px 18px", display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SectionLabel, { style: { display: "block", marginBottom: 8 } }, "Objective"), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: FONT_SANS, fontSize: 13, lineHeight: 1.65, color: C.textSecondary, margin: 0, letterSpacing: "-0.01em" } }, "Evaluate whether trehalose (0.1 M and 0.2 M) outperforms sucrose as a cryoprotectant for HeLa cells, targeting \u226515 percentage-point improvement in post-thaw viability.")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(SectionLabel, { style: { display: "block", marginBottom: 8 } }, "Active Step"), /* @__PURE__ */ React.createElement("div", { style: {
      background: C.bgBase,
      border: `1px solid ${C.borderSoft}`,
      borderRadius: 6,
      padding: "12px 14px"
    } }, /* @__PURE__ */ React.createElement("p", { style: { fontFamily: FONT_SANS, fontWeight: 600, fontSize: 13, color: C.textPrimary, margin: "0 0 6px", letterSpacing: "-0.01em" } }, "2 \xB7 Harvest HeLa cells (80% confluency)"), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: FONT_SANS, fontSize: 12, lineHeight: 1.6, color: C.textSecondary, margin: 0, letterSpacing: "-0.01em" } }, "Trypsinise cells with 0.25% trypsin-EDTA, count with haemocytometer, and adjust to 2 \xD7 10\u2076 cells/mL in complete DMEM. Ensure \u2265 95% viability before proceeding."))))
  ) : (
    /* Budget view */
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "16px 18px", display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 24, alignItems: "center" } }, /* @__PURE__ */ React.createElement(PieChart, { progress: pieProgress }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, PIE_SLICES.map((s, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 8, height: 8, borderRadius: 2, background: s.color, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textSecondary } }, s.label), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_MONO, fontSize: 11, color: C.textMuted, marginLeft: "auto" } }, Math.round(s.pct * 100), "%"))), /* @__PURE__ */ React.createElement("div", { style: { borderTop: `1px solid ${C.borderSoft}`, paddingTop: 8, marginTop: 2 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_MONO, fontSize: 14, fontWeight: 700, color: C.textPrimary } }, "$", TOTAL.toFixed(2), " total")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 1 } }, /* @__PURE__ */ React.createElement(SectionLabel, { style: { marginBottom: 6, display: "block" } }, "Line Items"), BUDGET_ITEMS.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
      opacity: rowOpArr[i],
      display: "flex",
      alignItems: "center",
      gap: 10,
      padding: "6px 8px",
      borderRadius: 5,
      background: i % 2 === 0 ? C.bgBase : "transparent"
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 12, color: C.textPrimary, flex: 1, letterSpacing: "-0.01em" } }, item.item), /* @__PURE__ */ React.createElement("span", { style: {
      fontFamily: FONT_MONO,
      fontSize: 10,
      color: C.textMuted,
      background: C.bgSurface,
      ...
      borderRadius: 3,
      flexShrink: 0
    } }, item.sku), /* @__PURE__ */ React.createElement("span", { style: {
      fontFamily: FONT_MONO,
      fontSize: 12,
      fontWeight: 600,
      color: C.textPrimary,
    ...
    gap: 8,
    flexShrink: 0
  } }, /* @__PURE__ */ React.createElement("div", { style: { width: 6, height: 6, borderRadius: "50%", background: C.success } }), /* @__PURE__ */ React.createElement(SectionLabel, null, "Protocol Assistant")), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    padding: "12px 14px",
    display: "flex",
    flexDirection: "column",
    gap: 10,
    overflowY: "auto"
  } }, /* @__PURE__ */ React.createElement("div", { style: { opacity: chat1Op } }, /* @__PURE__ */ React.createElement("div", { style: {
    padding: "8px 12px",
    borderRadius: 6,
    background: C.white,
    border: `1px solid ${C.borderSoft}`,
    ...
    letterSpacing: "-0.01em",
    alignSelf: "flex-end"
  } }, "What concentration of trehalose should I use?")), /* @__PURE__ */ React.createElement("div", { style: { opacity: chat2Op } }, /* @__PURE__ */ React.createElement("div", { style: {
    fontFamily: FONT_SANS,
    fontSize: 12,
    color: C.textSecondary,
    lineHeight: 1.65,
    letterSpacing: "-0.01em"
  } }, "Based on the literature, ", /* @__PURE__ */ React.createElement("strong", { style: { color: C.textPrimary } }, "0.2 M trehalose"), " shows optimal post-thaw recovery for HeLa cells. Include 0.1 M as a comparison arm to establish a dose-response. Both concentrations are compatible with standard controlled-rate freezing at \u22121\xB0C/min."))), /* @__PURE__ */ React.createElement("div", { style: {
    padding: "8px 12px",
    borderTop: `1px solid ${C.borderSoft}`,
    display: "flex",
    gap: 8,
    ...
    fontSize: 12,
    color: C.textMuted
  } }, "Ask about the protocol\u2026"), /* @__PURE__ */ React.createElement("div", { style: {
    width: 28,
    height: 28,
    borderRadius: 6,
    background: C.black,
    ...
    whiteSpace: "nowrap"
  } }, "Auto-generated budget breakdown")));
}

;// ./src/Scene5_Materials.jsx
...
const MATERIALS = [
  ...
  {
    name: "DMEM High Glucose w/ GlutaMAX",
  ...
  {
    name: "Nunc CryoTube vials 1.8 mL",
    supplier: "ThermoFisher",
    sku: "375418",
    qty: "500/pk",
    price: 44,
...
function SkuCard({ mat, opacity, y, highlighted = false, compareActive = false }) {
  return /* @__PURE__ */ React.createElement("div", { style: {
    opacity,
    transform: `translateY(${y}px)`,
    background: C.bgSurface,
    border: `1px solid ${highlighted ? "rgba(0,0,0,0.18)" : C.borderSoft}`,
    borderRadius: 8,
    padding: "12px 14px",
    display: "flex",
    flexDirection: "column",
  ...
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 600,
    fontSize: 12,
    color: C.textPrimary,
    ...
    letterSpacing: "-0.01em",
    lineHeight: 1.4
  } }, mat.name), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textMuted } }, mat.supplier)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 3 } }, /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 13,
    fontWeight: 700,
    color: C.textPrimary
  } }, "$", mat.price.toFixed(2)), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 10,
    fontWeight: 600,
    color: mat.inStock ? C.success : C.warning,
    background: mat.inStock ? C.successLight : C.warningLight,
    padding: "1px 6px",
    borderRadius: 3,
    border: `1px solid ${mat.inStock ? "rgba(45,122,58,0.2)" : "rgba(217,119,6,0.2)"}`
  } }, mat.inStock ? "In stock" : `${mat.leadDays}d lead`))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 10,
    color: C.textMuted,
    background: C.bgBase,
    ...
    padding: "2px 6px",
    borderRadius: 3
  } }, "SKU: ", mat.sku), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textMuted } }, mat.qty), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, color: C.textMuted, marginLeft: "auto" } }, mat.leadDays, "d delivery")), compareActive && /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    gap: 6
...
function Scene5_Materials() {
  const frame = (0,esm.useCurrentFrame)();
  const sceneOp = lerp(frame, [0, 12], [0, 1], ease.out);
  const cardOpArr = MATERIALS.map((_, i) => lerp(frame, [6 + i * 6, 20 + i * 6], [0, 1], ease.out));
  const cardYArr = MATERIALS.map((_, i) => lerp(frame, [6 + i * 6, 20 + i * 6], [10, 0], ease.out));
  const compareHighlight = lerp(frame, [60, 72], [0, 1], ease.out);
  const compareSc = lerp(frame, [64, 70], [1, 0.97], ease.inOut);
  const emailHighlight = lerp(frame, [100, 112], [0, 1], ease.out);
  const emailSc = lerp(frame, [104, 110], [1, 0.97], ease.inOut);
  const compareCalloutOp = lerp(frame, [62, 74], [0, 1], ease.out);
  const emailCalloutOp = lerp(frame, [102, 114], [0, 1], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { background: C.bgBase, opacity: sceneOp, flexDirection: "column" } }, /* @__PURE__ */ React.createElement(NavBar, null), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "grid",
    ...
    border: `1px solid ${C.borderSoft}`,
    color: C.textMuted
  } }, "6")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto", padding: "4px 6px" } }, ["Prepare cell culture medium", "Harvest HeLa cells", "Prepare cryoprotectant solutions", "Controlled-rate freezing", "Thaw cells & assess viability", "Statistical analysis"].map((step, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    display: "flex",
    alignItems: "center",
    gap: 8,
    padding: "7px 8px",
    ...
    borderRadius: "50%",
    flexShrink: 0,
    background: i < 3 ? C.success : C.textMuted
  } }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 12,
    color: i < 3 ? C.textSecondary : C.textMuted,
    letterSpacing: "-0.01em"
  } }, step))))), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    flexDirection: "column",
    ...
    background: C.bgBase,
    flexShrink: 0
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, ["Protocol", "Budget", "Materials", "Timeline"].map((t) => /* @__PURE__ */ React.createElement(TabPill, { key: t, label: t, active: t === "Materials" }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 500,
    fontSize: 12,
    padding: "5px 14px",
    borderRadius: 6,
    border: `1px solid ${C.borderSoft}`,
    background: compareHighlight > 0.5 ? C.bgHover : C.bgSurface,
    color: C.textPrimary,
    cursor: "pointer",
    transform: `scale(${compareSc})`,
    letterSpacing: "-0.01em"
  } }, "Compare suppliers"), /* @__PURE__ */ React.createElement("button", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 600,
    fontSize: 12,
    padding: "5px 14px",
    ...
    color: C.white,
    cursor: "pointer",
    transform: `scale(${emailSc})`,
    letterSpacing: "-0.01em",
    boxShadow: emailHighlight > 0.1 ? `0 0 0 ${Math.round(emailHighlight * 4)}px rgba(0,0,0,0.12)` : "none"
  } }, "Email Quote \u2709"))), /* @__PURE__ */ React.createElement("div", { style: {
    padding: "8px 18px",
    borderBottom: `1px solid ${C.borderSoft}`,
    display: "flex",
    gap: 24,
    ...
    { label: "Items", value: "6" },
    { label: "Est. Total", value: "$299.42" },
    { label: "In Stock", value: "5/6" },
    { label: "Max Lead", value: "7 days" }
  ].map(({ label, value }) => /* @__PURE__ */ React.createElement("div", { key: label, style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React.createElement(SectionLabel, null, label), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 13,
    fontWeight: 600,
    color: C.textPrimary
  } }, value)))), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    overflowY: "auto",
    padding: "14px 18px",
    display: "grid",
    ...
    gap: 10,
    alignContent: "start"
  } }, MATERIALS.map((mat, i) => /* @__PURE__ */ React.createElement(
    SkuCard,
    {
      key: i,
      mat,
      ...
      y: cardYArr[i],
      highlighted: i === 0,
      compareActive: compareHighlight > 0.5 && i < 3
    }
  ))))), compareCalloutOp > 0.05 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: 102,
    right: 280,
    opacity: compareCalloutOp
  } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    boxShadow: "0 4px 14px rgba(0,0,0,0.2)",
    whiteSpace: "nowrap"
  } }, "Compare prices across suppliers")), emailCalloutOp > 0.05 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: 102,
    right: 100,
    opacity: emailCalloutOp
  } }, /* @__PURE__ */ React.createElement("div", { style: {
    background: C.black,
    color: C.white,
    fontFamily: FONT_SANS,
    ...
    boxShadow: "0 4px 14px rgba(0,0,0,0.2)",
    whiteSpace: "nowrap"
  } }, "One-click quote to supplier")));
}

;// ./src/Scene6_Voice.jsx



const VOICE_EXCHANGE = [
  {
    role: "user",
    text: "How does trehalose compare to DMSO for HeLa cells?"
  },
  {
    role: "agent",
    text: "Great question. Based on the three papers I reviewed, trehalose at 0.2 M showed comparable post-thaw viability to 10% DMSO \u2014 around 85\u201388% \u2014 but without DMSO's cytotoxicity at room temperature. For HeLa specifically, trehalose is the safer choice for downstream assays."
  },
  {
    role: "user",
    text: "Should I adjust the freezing rate?"
  }
];
function VoiceWaveform({ frame, active, color = C.textPrimary }) {
  const barCount = 32;
  const bars = Array.from({ length: barCount }, (_, i) => {
    const phase = i / barCount * Math.PI * 2;
    const amplitude = active ? Math.abs(Math.sin(frame * 0.18 + phase)) * 0.7 + 0.15 : 0.08;
    return amplitude;
  });
  return /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    ...
    height: 40,
    padding: "0 4px"
  } }, bars.map((h, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    width: 3,
    borderRadius: 2,
    height: `${h * 100}%`,
    background: color,
...
function ChatMessage({ msg, opacity, y }) {
  const isUser = msg.role === "user";
  return /* @__PURE__ */ React.createElement("div", { style: {
    opacity,
    transform: `translateY(${y}px)`,
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M9 3h6M9 3v7l-5 9a1 1 0 00.9 1.5h12.2A1 1 0 0018 19l-5-9V3" })
  )), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 11, fontWeight: 600, color: C.textMuted } }, "LabProcure")), /* @__PURE__ */ React.createElement("div", { style: {
    maxWidth: "88%",
    padding: "8px 12px",
    borderRadius: 6,
    background: isUser ? C.white : "transparent",
...
function Scene6_Voice() {
  const frame = (0,esm.useCurrentFrame)();
  const sceneOp = lerp(frame, [0, 12], [0, 1], ease.out);
  const agentSpeaking = frame >= 10 && frame <= 55;
  const userSpeaking = frame >= 62 && frame <= 78;
  const m0Op = lerp(frame, [6, 18], [0, 1], ease.out);
  const m0Y = lerp(frame, [6, 18], [6, 0], ease.out);
  const m1Op = lerp(frame, [18, 36], [0, 1], ease.out);
  const m1Y = lerp(frame, [18, 36], [6, 0], ease.out);
  const m2Op = lerp(frame, [64, 76], [0, 1], ease.out);
  const m2Y = lerp(frame, [64, 76], [6, 0], ease.out);
  const micPulse = lerp(frame % 30, [0, 15], [1, 1.06], ease.out);
  const voiceCalloutOp = lerp(frame, [8, 20], [0, 1], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { background: C.bgBase, opacity: sceneOp, flexDirection: "column" } }, /* @__PURE__ */ React.createElement(NavBar, null), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "grid",
    ...
    display: "flex",
    flexDirection: "column"
  } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 10px 8px", borderBottom: `1px solid ${C.borderSoft}` } }, /* @__PURE__ */ React.createElement(SectionLabel, null, "Protocol")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, padding: "4px 6px" } }, ["Prepare cell culture medium", "Harvest HeLa cells", "Prepare cryoprotectant solutions", "Controlled-rate freezing", "Thaw cells & assess viability", "Statistical analysis"].map((step, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    display: "flex",
    alignItems: "center",
    gap: 8,
    padding: "7px 8px",
    ...
    height: 5,
    borderRadius: "50%",
    background: i < 4 ? C.success : C.textMuted
  } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: FONT_SANS, fontSize: 12, color: i < 4 ? C.textSecondary : C.textMuted, letterSpacing: "-0.01em" } }, step))))), /* @__PURE__ */ React.createElement("div", { style: {
    background: C.bgSurface,
    borderRight: `1px solid ${C.borderSoft}`,
    display: "flex",
    flexDirection: "column"
    ...
    gap: 8,
    flexShrink: 0
  } }, /* @__PURE__ */ React.createElement("div", { style: { width: 6, height: 6, borderRadius: "50%", background: C.success } }), /* @__PURE__ */ React.createElement(SectionLabel, null, "Protocol Chat")), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    padding: "12px 14px",
    overflowY: "auto",
    display: "flex",
    flexDirection: "column",
    gap: 10
  } }, /* @__PURE__ */ React.createElement(ChatMessage, { msg: VOICE_EXCHANGE[0], opacity: m0Op, y: m0Y }), /* @__PURE__ */ React.createElement(ChatMessage, { msg: VOICE_EXCHANGE[1], opacity: m1Op, y: m1Y }), /* @__PURE__ */ React.createElement(ChatMessage, { msg: VOICE_EXCHANGE[2], opacity: m2Op, y: m2Y })), /* @__PURE__ */ React.createElement("div", { style: {
    padding: "8px 12px",
    borderTop: `1px solid ${C.borderSoft}`,
    display: "flex",
    gap: 8,
    ...
    fontSize: 12,
    color: C.textMuted
  } }, "Ask about the study\u2026"), /* @__PURE__ */ React.createElement("div", { style: { width: 28, height: 28, borderRadius: 6, background: C.black, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("svg", { width: 11, height: 11, viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("line", { x1: "22", y1: "2", x2: "11", y2: "13" }), /* @__PURE__ */ React.createElement("polygon", { points: "22 2 15 22 11 13 2 9 22 2" }))))), /* @__PURE__ */ React.createElement("div", { style: {
    background: C.bgSurface,
    display: "flex",
    flexDirection: "column"
  } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    height: 6,
    borderRadius: "50%",
    background: agentSpeaking ? C.success : C.textMuted
  } }), /* @__PURE__ */ React.createElement(SectionLabel, null, "Voice Assistant"), agentSpeaking && /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 10,
    fontWeight: 600,
    color: C.success,
    marginLeft: "auto",
    letterSpacing: "-0.01em"
  } }, "\u25CF Speaking")), /* @__PURE__ */ React.createElement("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    ...
    height: 80,
    borderRadius: "50%",
    background: agentSpeaking ? C.bgBase : C.bgBase,
    border: `2px solid ${agentSpeaking ? C.success : C.borderSoft}`,
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    boxShadow: agentSpeaking ? `0 0 0 ${Math.round(lerp(frame % 30, [0, 30], [0, 8], ease.out))}px rgba(45,122,58,0.12)` : "none"
  } }, /* @__PURE__ */ React.createElement(
    "svg",
    {
      width: 28,
      ...
      viewBox: "0 0 24 24",
      fill: "none",
      stroke: agentSpeaking ? C.success : C.textMuted,
      strokeWidth: "1.6",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    },
    ...
    VoiceWaveform,
    {
      ...
      color: agentSpeaking ? C.success : C.textMuted
    }
  )), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    flexDirection: "column",
    ...
    height: 52,
    borderRadius: "50%",
    background: userSpeaking ? C.black : C.bgBase,
    border: `2px solid ${userSpeaking ? C.black : C.borderSoft}`,
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    transform: `scale(${userSpeaking ? micPulse : 1})`,
    cursor: "pointer"
  } }, /* @__PURE__ */ React.createElement(MicIcon, { size: 20, color: userSpeaking ? C.white : C.textMuted })), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontSize: 11,
    color: C.textMuted,
    letterSpacing: "-0.01em"
  } }, userSpeaking ? "Listening\u2026" : "Tap to speak")), /* @__PURE__ */ React.createElement("div", { style: {
    fontFamily: FONT_SANS,
    fontSize: 11,
    fontWeight: 500,
    color: C.textMuted,
    ...
    borderRadius: 20,
    letterSpacing: "-0.01em"
  } }, agentSpeaking ? "Answering based on your protocol & literature\u2026" : userSpeaking ? "Processing your question\u2026" : "Ask anything about your experiment")))), voiceCalloutOp > 0.05 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    top: 200,
    right: 60,
    opacity: voiceCalloutOp
  } }, /* @__PURE__ */ React.createElement("div", { style: {
    background: C.black,
    color: C.white,
    fontFamily: FONT_SANS,
    ...
    boxShadow: "0 4px 14px rgba(0,0,0,0.2)",
    whiteSpace: "nowrap"
  } }, "Voice AI grounded in your experiment")));
}
...
function Scene7_CTA() {
  const frame = (0,esm.useCurrentFrame)();
  const logoOp = lerp(frame, [0, 18], [0, 1], ease.out);
  const logoSc = lerp(frame, [0, 18], [0.85, 1], ease.out);
  const h1Op = lerp(frame, [16, 32], [0, 1], ease.out);
  const h1Y = lerp(frame, [16, 32], [12, 0], ease.out);
  const h2Op = lerp(frame, [26, 42], [0, 1], ease.out);
  const h2Y = lerp(frame, [26, 42], [12, 0], ease.out);
  const subOp = lerp(frame, [38, 54], [0, 1], ease.out);
  const subY = lerp(frame, [38, 54], [8, 0], ease.out);
  const pillOp = [
    lerp(frame, [48, 60], [0, 1], ease.out),
    lerp(frame, [54, 66], [0, 1], ease.out),
    lerp(frame, [60, 72], [0, 1], ease.out),
    lerp(frame, [66, 78], [0, 1], ease.out)
  ];
  const pillSc = pillOp.map(
    (op, i) => lerp(frame, [48 + i * 6, 60 + i * 6], [0.88, 1], ease.pop)
  );
  const PILLS = [
    "\u{1F52C} Literature QC",
    "\u{1F4CB} Protocol generation",
    "\u{1F4B0} Budget & procurement",
    "\u{1F399} Voice AI assistant"
  ];
  const urlOp = lerp(frame, [78, 90], [0, 1], ease.out);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
    background: C.bgBase,
    display: "flex",
    flexDirection: "column",
    ...
    gap: 10,
    marginBottom: 36
  } }, /* @__PURE__ */ React.createElement(FlaskIcon, { size: 28, color: C.textPrimary }), /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 16,
    letterSpacing: "-0.02em",
    color: C.textMuted
  } }, "LabProcure")), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { opacity: h1Op, transform: `translateY(${h1Y}px)` } }, /* @__PURE__ */ React.createElement("h1", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 700,
    fontSize: 70,
    lineHeight: 1.06,
    ...
    color: C.textPrimary,
    margin: 0
  } }, "Science, automated.")), /* @__PURE__ */ React.createElement("div", { style: { opacity: h2Op, transform: `translateY(${h2Y}px)` } }, /* @__PURE__ */ React.createElement("h2", { style: {
    fontFamily: FONT_SANS,
    fontWeight: 400,
    fontSize: 32,
    lineHeight: 1.3,
    ...
    color: C.textMuted,
    margin: "8px 0 0"
  } }, "From hypothesis to purchase order."))), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    gap: 10,
    flexWrap: "wrap",
    justifyContent: "center",
    marginBottom: 36,
    maxWidth: 600
  } }, PILLS.map((pill, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
    opacity: pillOp[i],
    transform: `scale(${pillSc[i]})`,
    fontFamily: FONT_SANS,
    fontWeight: 500,
    fontSize: 13,
    padding: "7px 16px",
    ...
    color: C.textSecondary,
    letterSpacing: "-0.01em"
  } }, pill))), /* @__PURE__ */ React.createElement("div", { style: { opacity: subOp, transform: `translateY(${subY}px)`, marginBottom: 28 } }, /* @__PURE__ */ React.createElement("p", { style: {
    fontFamily: FONT_SANS,
    fontSize: 16,
    lineHeight: 1.6,
    color: C.textSecondary,
    ...
    margin: 0,
    maxWidth: 480
  } }, "The AI-powered platform that takes scientists from idea to experiment-ready in minutes \u2014 not weeks.")), /* @__PURE__ */ React.createElement("div", { style: { opacity: urlOp } }, /* @__PURE__ */ React.createElement("span", { style: {
    fontFamily: FONT_MONO,
    fontSize: 14,
    fontWeight: 500,
    color: C.textMuted,
...
function LabProcureVideo() {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { fontFamily: "'Inter', system-ui, sans-serif" } }, /* @__PURE__ */ React.createElement(TransitionSeries, null, /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 90 }, /* @__PURE__ */ React.createElement(Scene0_Hook, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: fade(),
      timing: linearTiming({ durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 120 }, /* @__PURE__ */ React.createElement(Scene1_Input, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: slide_slide({ direction: "from-right" }),
      timing: springTiming({ config: { damping: 200 }, durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 150 }, /* @__PURE__ */ React.createElement(Scene2_LiteratureQC, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: fade(),
      timing: linearTiming({ durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 60 }, /* @__PURE__ */ React.createElement(Scene3_Loading, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: fade(),
      timing: linearTiming({ durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ React.createElement(Scene4_Protocol, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: slide_slide({ direction: "from-right" }),
      timing: springTiming({ config: { damping: 200 }, durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ React.createElement(Scene5_Materials, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: slide_slide({ direction: "from-right" }),
      timing: springTiming({ config: { damping: 200 }, durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 90 }, /* @__PURE__ */ React.createElement(Scene6_Voice, null)), /* @__PURE__ */ React.createElement(
    TransitionSeries.Transition,
    {
      presentation: fade(),
      timing: linearTiming({ durationInFrames: TRANS_FRAMES })
    }
  ), /* @__PURE__ */ React.createElement(TransitionSeries.Sequence, { durationInFrames: 120 }, /* @__PURE__ */ React.createElement(Scene7_CTA, null))));
}
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(757), __webpack_require__.e(533), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 7533)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "labprocure-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklabprocure_video"] = self["webpackChunklabprocure_video"] || [];
